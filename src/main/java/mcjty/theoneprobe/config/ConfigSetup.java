...
public class ConfigSetup {
    ...
    public static boolean spawnNotification = true;
    ...
    public static void init(Configuration cfg) {
        ...
        spawnNotification = cfg.getBoolean("spawnNotification", CATEGORY_THEONEPROBE, spawnNotification, "If true game will send notification for first-time players");
